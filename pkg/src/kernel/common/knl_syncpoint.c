...
knl_global_syncpoint_def g_knl_syncpoint[] = {
    ...
    { COLLECT_STATISTICS_ANALYZED_DATA_FAIL, CT_FALSE, "COLLECT_STATISTICS_ANALYZED_DATA_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { COLLECT_STATISTICS_INDEX_TABLE_FAIL, CT_FALSE, "COLLECT_STATISTICS_INDEX_TABLE_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
    { COLLECT_STATISTICS_PERSISTENCE_THROUGH_RESULT_TABLE_FAIL, CT_FALSE, "COLLECT_STATISTICS_PERSISTENCE_THROUGH_RESULT_TABLE_FAIL", 0,
      knl_syncpoint_inject_errcode, 0 },
};
