del /Q gs_regress.exe ctsql.exe gsc.dll libipsi_crypto.dll libipsi_osal.dll libipsi_pse.dll libipsi_ssl.dll lib_security.dll
del /Q results\*.out results\*.log results\*.diff 
del /Q %CTDB_HOME%\cumu_*.bak*
del /Q %CTDB_HOME%\cantiandb_*.bak*
copy /B /Y "..\..\bin\Win32\Debug\gs_regress.exe"  "."
...
.\gs_regress.exe --host=127.0.0.1 --port=1611 --schedule=.\gs_schedule_hard_parse
