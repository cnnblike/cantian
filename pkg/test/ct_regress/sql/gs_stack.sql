...
DROP TABLE IF EXISTS "TEST_STACK_T1" CASCADE CONSTRAINTS;
CREATE TABLE "TEST_STACK_T1"
(
  "COL_INT" BINARY_INTEGER NOT NULL,
  "COL_INTEGER" BINARY_INTEGER,
  "COL_BINARY_INTEGER" BINARY_INTEGER,
  "COL_SMALLINT" BINARY_INTEGER NOT NULL DEFAULT '7',
  "COL_BIGINT" BINARY_BIGINT NOT NULL DEFAULT '3',
  "COL_BINARY_BIGINT" BINARY_BIGINT,
  "COL_REAL" BINARY_DOUBLE,
  ...
  "COL_NUMERIC" NUMBER,
  "COL_CHAR1" CHAR(100 BYTE),
  "COL_CHAR2" CHAR(8000 BYTE),
  "COL_NCHAR1" CHAR(100 CHAR),
  "COL_NCHAR2" CHAR(8000 CHAR),
  "COL_VARCHAR_200" VARCHAR(100 BYTE),
  "COL_VARCHAR_8000" VARCHAR(8000 BYTE) DEFAULT 'aaaabbbb',
  "COL_VARCHAR2_1000" VARCHAR(100 BYTE),
  "COL_VARCHAR2_8000" VARCHAR(8000 BYTE),
  "COL_NVARCHAR1" VARCHAR(100 CHAR),
  "COL_NVARCHAR2" VARCHAR(8000 CHAR),
  "COL_NVARCHAR2_1000" VARCHAR(100 CHAR),
  "COL_NVARCHAR2_8000" VARCHAR(8000 CHAR),
  "COL_CLOB" CLOB,
  "COL_TEXT" CLOB,
  "COL_LONGTEXT" CLOB,
  "COL_IMAGE" IMAGE,
