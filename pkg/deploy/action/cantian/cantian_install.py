...
def use_default_log_path():
    # The default log is ~/cantian_deploy.log
...
class Installer:
    ...
    def check_config_options(self):
        ...
        for key, value in self.cantiand_configs.items():
            if not isinstance(value, str):
                value = str(value)
                self.cantiand_configs[key] = value
            try:
