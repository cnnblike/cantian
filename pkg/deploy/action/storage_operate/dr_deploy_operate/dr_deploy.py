...
class DRDeploy(object):
    ...
    def execute(self):
        ...
        def _execute():
            ...
            shutil.copyfile(os.path.join(CURRENT_PATH, "../../../config/dr_deploy_param.json"), "/opt/cantian/config/")
            share_path = f"/mnt/dbdata/metadata_{self.dr_deploy_info.get("storage_metadata_fs")}"
            shutil.copyfile(os.path.join(CURRENT_PATH, "../../../config/dr_deploy_param.json"), share_path)
